...
Tiled measurement sync: live cameras and microphones, a shared RAM capture buffer, and a timeline every viewer can scrub independently.
...
3. **Timeline** — live by default. Click to scrub, scroll to zoom the window. Camera tiles show the frame at the window centre; audio tiles show the envelope over the window.
